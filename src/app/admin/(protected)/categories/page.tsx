...
import { ToggleCategoryVisibilityButton } from "@/components/admin/ToggleCategoryVisibilityButton";
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex shrink-0 flex-wrap items-center gap-3">
                <ToggleCategoryVisibilityButton
            ...
            {childrenOf(category.id).length > 0 && (
              <ul className="mt-3 flex flex-col gap-2 border-t border-neutral-100 pt-3">
                {childrenOf(category.id).map((child) => (
                  <li
                    key={child.id}
                    className="flex flex-wrap items-center justify-between gap-2 pr-4"
                  >
