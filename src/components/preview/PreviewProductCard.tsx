...
// نسخة من ProductCard تشير إلى /preview/product/[slug] بدل /product/[slug].
export function PreviewProductCard({ product }: { product: CatalogProduct }) {
  const imageUrl = product.primary_image_path;

  return (
    <Link
      href={`/preview/product/${product.slug}`}
